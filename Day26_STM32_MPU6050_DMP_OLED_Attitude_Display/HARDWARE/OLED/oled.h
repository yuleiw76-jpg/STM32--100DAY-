...
#define OLED_SDIN_Read() GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_7)
#define OLED_SDA_IN()  {GPIOB->CRL&=0X0FFFFFFF;GPIOB->CRL|=(u32)8<<28;OLED_SDIN_Set();}
#define OLED_SDA_OUT() {GPIOB->CRL&=0X0FFFFFFF;GPIOB->CRL|=(u32)3<<28;}

#define OLED_I2C_ADDRESS_3C 0x78
#define OLED_I2C_ADDRESS_3D 0x7A
